...
env.newPropertyUInt("POPULATION_TO_GENERATE", 512); #32768);
...
env.newPropertyFloat("MAX_INITIAL_SPEED", 0.50);
...
# Rule scalers
env.newPropertyFloat("STEER_SCALE", 0.45);
...
if pyflamegpu.VISUALISATION:
    ...
    visualisation.setSimulationSpeed(200);
...
if not cudaSimulation.SimulationConfig().input_file:
    ...
    cudaSimulation.SimulationConfig().steps = 100000000
